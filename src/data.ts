...
export const FRAMES = [
  { id: 0, url: '/history', title: 'Historial', image: 'https://e0.pxfuel.com/wallpapers/970/9/desktop-wallpaper-green-forest-trees-dark-green-forest.jpg' },
...
export const LOCATIONS = [
  { id: 0, url: '', title: 'Lleida', subtitle: 'Pardinyes', image: 'https://urbanisme.paeria.cat/sostenibilitat/fitxers/residus-i-neteja-viaria/fotos-deixalleries/deixalleria-fixa' },
  { id: 1, url: '', title: 'Lleida', subtitle: 'Deixalleria Municipal', image: 'https://urbanisme.paeria.cat/sostenibilitat/fitxers/residus-i-neteja-viaria/fotos-deixalleries/deixalleria-1' },
  { id: 2, url: '', title: 'Manresa', subtitle: '', image: 'https://ajuntament.barcelona.cat/neteja-i-residus/sites/default/files/2023-05/PVB_Sant_Andreu_2.jpg' },
  { id: 3, url: '', title: 'Amposta', subtitle: '', image: 'https://www.olesademontserrat.cat/sites/default/files/2023-04/deixalleria-municipal.jpg' },
  { id: 4, url: '', title: 'Cervera', subtitle: '', image: 'https://www.viladetora.net/images/fotos/original/1299958469.jpg' }
];
